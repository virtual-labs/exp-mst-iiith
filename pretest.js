...
{
question: "5. Choose one of the correct statements from the following?",  ///// Write the question inside double quotes
answers: {
a: " Trees may have cycles but not graphs. ",                  ///// Write the option 1 inside double quotes
b: "Graphs may have cycles but not trees ",                  ///// Write the option 2 inside double quotes
c: "Time complexity of Union-Find is O(n<sup>2</sup>)  ", ///// Write the option 3 inside double quotes
d: "Time complexity of Union-Find is O(nlog(n)) ", ///// Write the option 4 inside double quotes
},
correctAnswer: "b"                ///// Write the correct option inside double quotes
},
{
question: "6. What is the best possible order in which an array can be sorted?",  ///// Write the question inside double quotes
answers: {
a: " O(n<sup>2</sup>) ",                  ///// Write the option 1 inside double quotes
b: "O(nlog(n)) ",                  ///// Write the option 2 inside double quotes
c: " O(n)  ", ///// Write the option 3 inside double quotes
d: "O(log(n)) ", ///// Write the option 4 inside double quotes
},
correctAnswer: "b"                ///// Write the correct option inside double quotes
},
